...
``` {r export dataset}
setwd("../exported_data")
write.table(Dataset_homogen,"Isotope_data_standardized.txt")

tiny_dataset <- Dataset_homogen %>% dplyr::select(Pond, Species_precis, Species_Odo, 
                                           Taxa, Sample_ID, TP, D13Ccor_consoI) 
